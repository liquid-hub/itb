...
var system=require("../variables").system,updateContentData=require("./updateContentData"),testRequire=require("./helpers").testRequire,emailTest=require("./helpers").emailTest,getPhoneNumberLength=require("./helpers").getPhoneNumberLength,punycode=require("punycode");function checkDuplicateId(e){var r=!1,t=e.get(0);t.id&&($('[id="'+t.id+'"]').length>1&&(r=!0,console.warn("Внимание! Задвоенный идентификатор - #"+t.id+". Форма может некорректно отправляться.")));return r}function checkProduct(){return window.location.pathname.indexOf("/product/")>-1}function validateFormData(e){var r=this,t=$.Deferred(),n=[],o=r.options.require,a=e,s=testRequire("from",o),u=validateFrom(a.from,s,r.options.errorMessages.from);a.from=u.value,u.isError&&n.push({name:"from",errorMessage:u.errorMessage});var i=testRequire("phone",o),c=validatePhone(a.phone,i,r.options.phoneNumberLength,r.options.errorMessages.phone);a.phone=c.value,i||""!==c.value||delete a.phone,c.isError&&n.push({name:"phone",errorMessage:c.errorMessage});var l=testRequire("name",o),d=validateName(a.name,l,r.options.errorMessages.name);a.name=d.value,l||""!==d.value||delete a.name,d.isError&&n.push({name:"name",errorMessage:d.errorMessage});var v=testRequire("subject",o),h=validateSubject(a.subject,v,r.options.errorMessages.subject);if(a.subject=h.value,h.isError&&n.push({name:"subject",errorMessage:h.errorMessage}),r.options.useDefaultContent||a.content)updateContentData(r,a.content,n.length>0).done(function(e){a.content=e;var o=validateContent(a.content,!r.options.useDefaultContent);a.content=o.value,o.isError&&n.push({name:"content",errorMessage:o.errorMessage}),n.length>0?t.reject(n):t.resolve(a)});else{var m=validateContent(a.content,!r.options.useDefaultContent,r.options.errorMessages.content);a.content=m.value,m.isError&&n.push({name:"content",errorMessage:m.errorMessage}),n.length>0?t.reject(n):t.resolve(a)}return t.promise()}function validatePhone(e,r,t,n){e||(e="");var o={isError:!1,errorMessage:n,value:decodeURIComponent(e.replace(/%(?!\d+)/g,"%25"))};(e=decodeURIComponent(e.replace(/%(?!\d+)/g,"%25")),r||e)?r&&(e?t>getPhoneNumberLength(e)&&(o.isError=!0):o.isError=!0):o.value=system.dataDefault.phone;return o}function validateFrom(e,r,t){e||(e="");var n={isError:!1,errorMessage:t,value:e};if(r||e)e&&emailTest(e)||(n.isError=!0);else{var o=window.location.host;-1===o.indexOf(".")&&(o="myinsales.ru"),n.value="shop@"+punycode.toUnicode(o)}return n}function validateName(e,r,t){e||(e="");var n={isError:!1,errorMessage:t,value:e};return r||e?e||(n.isError=!0):n.value=system.dataDefault.name,n}function validateSubject(e,r,t){e||(e="");var n={isError:!1,errorMessage:t,value:e};return r||e?e||(n.isError=!0):n.value=system.dataDefault.subject,n}function validateContent(e,r,t){var n={isError:!1,errorMessage:t,value:e},o=e.trim();return e&&""!==o?r||(n.value=system.dataDefault.content):(n.isError=!0,n.value=""),n}function checkNameContent(e){0===e.find('[name="content"]').length&&console.warn("В форме отсутствует поле content",e)}function checkAgree(e,r,t,n){var o=!0;if(t){var a=e.find("["+r+"]");0!==a.length&&a.prop("checked")||(o=!1),0===a.length&&console.warn("Отсутствует чекбокс согласия на обработку персональных данных")}return o}module.exports={checkDuplicateId:checkDuplicateId,checkProduct:checkProduct,checkAgree:checkAgree,checkNameContent:checkNameContent,validateFormData:validateFormData};
